classdef track1
    ...
    properties (Dependent = true)
        x,y,outside,inside,e1,e2,w,h,w2,h2,H,W,nodes,sx,sy
    end
    methods
        % dimensions of track
        ...
        function x = get.x(obj)
            x = [obj.d obj.d+2*obj.K obj.d+3*obj.K obj.d+5*obj.K...
                obj.d+6*obj.K obj.d+8*obj.K];end
        function y = get.y(obj)
            y = [obj.d obj.d+obj.e1 obj.d+obj.e1+obj.e2...
                obj.d+obj.e1+obj.h2/2 obj.d+obj.e1+obj.h...
                obj.d+obj.e1+obj.h obj.d+obj.e1+obj.h+obj.e1];end
        function H = get.H(obj)
            H = obj.y(7);end
        function W = get.W(obj)
            W = obj.x(6);end
        ...
        function nodes = get.nodes(obj)
            nodes = rand([obj.H+10 obj.W+10]); % initialize the value matrix
