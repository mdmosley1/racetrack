...
inside = [x(5) x(5) x(2) x(2) x(3) x(8) x(9)...
          x(9) x(6) x(6) x(9) x(9) x(8) x(3) x(2) x(2) x(5);
          y(6) y(9) y(11) y(12) y(13) y(13) y(12)...
          y(11) y(9) y(6) y(4) y(3) y(2) y(2) y(3) y(4) y(6)];
outside = [x(4) x(4) x(1) x(1) x(3) x(9) x(10)...
           x(10) x(7) x(7) x(10) x(10) x(9) x(2) x(1) x(1) x(4) ;
           y(7) y(8) y(10) y(13) y(14) y(14) y(13)...
           y(10) y(8) y(7) y(5) y(2) y(1) y(1) y(2) y(5) y(7)];
